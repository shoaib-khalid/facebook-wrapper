...
public class Utilities {
    ...
    private static final String backendIP
            = ConfigReader.environment.getProperty("backend.ip", "127.0.0.1");
    private static final int backendPort = ConfigReader.getPropertyAsInt("backend.port", 9100);

    public static void writeCDR(
            String refId, String currEvent, String aParty, String bParty, String param1, String param2) {
        try {
            String rowData
                    = refId + "," + currEvent + "," + aParty + "," + bParty + "," + param1 + "," + param2;
    ...
    public static String sendPostRequest(
            String backendEndPoint, String queryParams, String requestBody) {
